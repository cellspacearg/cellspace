import Router from './core/router.js?v=cb13';
import { checkSession } from './hooks/useAuth.js?v=cb13';
import { loginView, loginViewOnMount } from './views/login.js?v=cb13';
import { dashboardView, dashboardViewOnMount } from './views/dashboard.js?v=cb13';
import { productsView, productsViewOnMount } from './views/products.js?v=cb13';
import { categoriesView, categoriesViewOnMount } from './views/categories.js?v=cb13';
import { servicesView, servicesViewOnMount } from './views/services.js?v=cb13';
import { pagesView, pagesViewOnMount } from './views/pages.js?v=cb13';
import { builderView, builderViewOnMount } from './views/builder.js?v=cb13';
import { mediaView, mediaViewOnMount } from './views/media.js?v=cb13';
import { settingsView, settingsViewOnMount } from './views/settings.js?v=cb13';
import { customersView, customersViewOnMount } from './views/customers.js?v=cb13';
import { ordersView, ordersViewOnMount } from './views/orders.js?v=cb13';
import { centralView, centralViewOnMount } from './views/central.js?v=cb13';
import { repairsView, repairsViewOnMount } from './views/repairs.js?v=cb13';
import { inventoryView, inventoryViewOnMount } from './views/inventory.js?v=cb13';
import { reportsView, reportsViewOnMount } from './views/reports.js?v=cb13';
import { suppliersView, suppliersViewOnMount } from './views/suppliers.js?v=cb13';
import { expensesView, expensesViewOnMount } from './views/expenses.js?v=cb13';
import { promotionsView, promotionsViewOnMount } from './views/promotions.js?v=cb13';
import { techniciansView, techniciansViewOnMount } from './views/technicians.js?v=cb13';
import { auditView, auditViewOnMount } from './views/audit.js?v=cb13';
import { notificationsView, notificationsViewOnMount } from './views/notifications.js?v=cb13';
import { socialView, socialViewOnMount } from './views/social.js?v=cb13';
import { notFoundView, notFoundViewOnMount } from './views/not-found.js?v=cb13';
