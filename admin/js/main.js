import Router from './core/router.js?v=cb15';
import { checkSession } from './hooks/useAuth.js?v=cb15';
import { loginView, loginViewOnMount } from './views/login.js?v=cb15';
import { dashboardView, dashboardViewOnMount } from './views/dashboard.js?v=cb15';
import { productsView, productsViewOnMount } from './views/products.js?v=cb15';
import { categoriesView, categoriesViewOnMount } from './views/categories.js?v=cb15';
import { servicesView, servicesViewOnMount } from './views/services.js?v=cb15';
import { pagesView, pagesViewOnMount } from './views/pages.js?v=cb15';
import { builderView, builderViewOnMount } from './views/builder.js?v=cb15';
import { mediaView, mediaViewOnMount } from './views/media.js?v=cb15';
import { settingsView, settingsViewOnMount } from './views/settings.js?v=cb15';
import { customersView, customersViewOnMount } from './views/customers.js?v=cb15';
import { ordersView, ordersViewOnMount } from './views/orders.js?v=cb15';
import { centralView, centralViewOnMount } from './views/central.js?v=cb15';
import { repairsView, repairsViewOnMount } from './views/repairs.js?v=cb15';
import { inventoryView, inventoryViewOnMount } from './views/inventory.js?v=cb15';
import { reportsView, reportsViewOnMount } from './views/reports.js?v=cb15';
import { suppliersView, suppliersViewOnMount } from './views/suppliers.js?v=cb15';
import { expensesView, expensesViewOnMount } from './views/expenses.js?v=cb15';
import { promotionsView, promotionsViewOnMount } from './views/promotions.js?v=cb15';
import { techniciansView, techniciansViewOnMount } from './views/technicians.js?v=cb15';
import { auditView, auditViewOnMount } from './views/audit.js?v=cb15';
import { notificationsView, notificationsViewOnMount } from './views/notifications.js?v=cb15';
import { socialView, socialViewOnMount } from './views/social.js?v=cb15';
import { notFoundView, notFoundViewOnMount } from './views/not-found.js?v=cb15';
