...
(function () {
  ...
  /* ---- 12.D: footer dinámico (redes + contacto) ---- */
  ...
  function applyFooter(cfg){
    // Redes sociales: mapeo por ícono dentro de .footer-brand .social-links
    var map = {
    ...
    // Contacto: reescribe el texto del <li> conservando el ícono, dentro de .contact-info
  ...
  function applyAll(cfg){
    ...
    try { applyFooter(cfg); } catch (e) {}      // 12.D
    try { applyMaintenance(cfg); } catch (e) {} // último: por si bloquea, que ya esté todo lo demás
